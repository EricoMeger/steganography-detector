...
ser aprimoradas coletivamente. Nesse contexto, métodos de proteção à
privacidade e comunicação segura, como a esteganografia, encontram terreno
fértil para desenvolvimento. A combinação entre os valores culturais do
software livre e suas virtudes técnicas confere ao estudo da esteganografia um
fundamento ético e prático robusto.
...
Esse trabalho propõe a criação de modelos de IA para detecção de estanografia
em imagens, usando bibliotecas de código aberto.
