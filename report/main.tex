...
O movimento do software livre tem se consolidado como uma das principais formas de garantir transparência, colaboração e inovação no desenvolvimento tecnológico. 
Ao permitir o acesso aberto ao código-fonte e a livre modificação pelos usuários, ele cria um ambiente no qual ferramentas podem ser testadas, auditadas e aprimoradas coletivamente. 
Essa abertura contribui para o fortalecimento da confiança em soluções digitais e amplia as possibilidades de aplicação em diferentes áreas. 
Entre essas aplicações, destacam-se os métodos de proteção da privacidade e da comunicação segura, nos quais a esteganografia se insere como uma técnica de grande relevância.
  
A esteganografia pode ser compreendida como uma técnica utilizada para esconder informações em meios aparentemente comuns, 
de forma que um observador externo não consiga identificar a presença de dados ocultos \cite{Fridrich2010}. 
