...
performance quando comparado a abordagens baseadas em redes neurais.

Por outro lado, as abordagens baseadas em CNNs, exemplificadas pela SRNet e
pelas adaptações da EfficientNet, demonstraram superioridade técnica,
aprendendo de forma automatizada. Entretanto, observou-se que essa evolução
técnica trouxe consigo um novo desafio: a barreira do custo computacional. A
exigência de hardware de alto desempenho para o treinamento desses modelos
restringe a acessibilidade que o software livre visa promover, criando um
distanciamento entre a precisão acadêmica e a aplicação prática por usuários
comuns.
