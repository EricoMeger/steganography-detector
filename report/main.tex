...
A esteganografia, portanto, não se limita apenas ao ato de esconder
informações, mas envolve um campo de estudo mais amplo que abrange técnicas,
...
mensagens mas não esconde sua existência, a esteganografia busca mascarar o
próprio ato de comunicação. Esse caráter sutil faz dela uma área estratégica
tanto para aplicações legítimas — como proteção de direitos autorais,
autenticação de documentos e privacidade de dados — quanto para usos
maliciosos. Essa dualidade evidencia que a esteganografia não deve ser
compreendida apenas sob uma ótica técnica, mas também dentro de um contexto
